...
// TODO: Not sure how the AMR_RTP_SPEC_IUUP_INSTEAD_OF_RFC option affects this part. It obviously fails the parsing
// so it probably affects Asterisk's intelligence somehow.
